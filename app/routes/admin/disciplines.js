...
// Services
const userService = require('../../services/admin/usersGroups');
const service = require('../../services/admin/disciplines');
// Base Routes
 ...
 *        description: Uncaught error
 */
const putAllCoachesByDiscipline = async (req, res) => {
  let id = parseInt(req.params['id']);
  let object = req.body;
  const resp = await baseRoute(
    req,
...
if (PERMISOLOGIES == 0) {
  ...
  routes.put('/:id/coaches', putAllCoachesByDiscipline);
} else {
